  ...
  return (
    <Link href={`/offers/${offerId}`} className="cursor-pointer">
      <Card className="flex flex-col items-center gap-4 border-border bg-card p-4 transition-all duration-300 hover:scale-[1.01] sm:flex-row">
        {/* Token Info */}
        <div className="flex w-full flex-shrink-0 items-center gap-4 sm:w-32 xl:w-40">
        ...
        {/* Price & Sold */}
        <div className="flex w-full flex-shrink-0 flex-col items-start sm:w-48 xl:w-60">
          {/* <span className="text-sm text-gray-600">Price</span> */}

          <div className="flex w-full items-end gap-4">
            <div className="relative flex max-w-[calc(60%)] flex-1 flex-col gap-2">
              <div className="text-content inline-flex items-center whitespace-nowrap text-xs">
                <span>
                ...
                {formatNumberShort(minus(offer.quantity, offer.filled), {
        ...
        <div className="grid min-w-24 flex-1 gap-1 text-sm lg:w-auto lg:flex-1 xl:min-w-32">
          <div className="flex items-center gap-1">
            <span className="text-content">Collateral:</span>
            <span className={cn('font-medium')}>{`${offer.collateralPercent}%`}</span>
          </div>
          <div className="flex items-center gap-1">
            <span className="text-content whitespace-nowrap">Settle Duration:</span>
        ...
        >
          View <span className="hidden xl:inline">Offer</span>
        </Link>
      </Card>
    </Link>
  );
